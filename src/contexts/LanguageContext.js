...
const translations = {
  en: {
    ...
    manageSystemConfiguration: "Manage system configuration and settings",
    general: "General",
    ...
    currency: "Currency",
    dashboardDescription: "View real-time analytics and insights",
    itemsDescription: "Manage inventory items and stock",
    salesDescription: "Process and manage sales transactions",
    categoriesDescription: "Organize items by category",
    tablesDescription: "Manage restaurant tables",
    usersDescription: "Create and manage user accounts",
    ...
    enableAndConfigureTax: "Enable and configure tax settings",
    tax: "Tax",
    taxRatePercent: "Tax Rate (%)",
    saveSettings: "Save Settings",
    configurePaymentOptions: "Configure available payment options",
    transfer: "Transfer",
    debit: "Debit",
    availableForTransactions: "Available for transactions",
    disabled: "Disabled",
    enabled: "Enabled",
    ...
    areYouSureDeleteTable: "Are you sure you want to delete",
  ...
  id: {
    ...
    enableAndConfigureTax: "Aktifkan dan konfigurasi pengaturan pajak",
    tax: "Pajak",
    taxRatePercent: "Tarif Pajak (%)",
    saveSettings: "Simpan Pengaturan",
    configurePaymentOptions: "Konfigurasi opsi pembayaran yang tersedia",
    transfer: "Transfer",
    debit: "Debit",
    availableForTransactions: "Tersedia untuk transaksi",
    disabled: "Nonaktif",
    enabled: "Aktif",
    ...
    tableConfiguration: "Konfigurasi Meja",
    saveTableCount: "Simpan Jumlah Meja",
    tables: "Meja",
    addTable: "Tambah Meja",
    name: "Nama",
    capacity: "Kapasitas",
    actions: "Aksi",
    noTablesFound: "Tidak ada meja ditemukan",
    editTable: "Edit Meja",
    addNewTable: "Tambah Meja Baru",
    tableName: "Nama Meja",
    update: "Perbarui",
    confirmDeletion: "Konfirmasi Penghapusan",
    areYouSureDeleteTable: "Apakah Anda yakin ingin menghapus",
