        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 mt-8">
            <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
              <h3 className="font-bold text-foreground mb-2">Light Card</h3>
              <p className="text-gray-600 dark:text-gray-300">This card should change background</p>
            </div>
            
            <div className="bg-red-100 dark:bg-red-900 p-4 rounded-lg">
              <h3 className="font-bold text-foreground mb-2">Colored Card</h3>
          ...
          <div className="mt-8 p-4 border border-gray-300 dark:border-gray-700 rounded-lg">
            <h3 className="font-bold text-foreground mb-2">Document Info</h3>
