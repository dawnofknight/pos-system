            ...
            <div className='bg-white rounded-lg shadow-sm border border-gray-200'>
              ...
              <div className='p-6'>
                <SkeletonTable
                  rows={6}
                  columns={3}
                  headers={["Category", "Items Count", "Actions"]}
                />
              </div>
            </div>
          </div>
      ...
      <DashboardLayout>
        <div className='space-y-4 md:space-y-8'>
          ...
          <Card
            variant='glass'
            hover={true}
            className='backdrop-blur-xl border-white/20 shadow-xl'
          >
            <CardHeader
              variant='glass'
            ...
            <div className='p-6'>
              {itemsLoading ? (
                ...
                <div className='text-center py-8'>
                  ...
                  <p className='text-gray-600'>{t("categoryNoItems")}</p>
                </div>
              )}
            </div>
          </Modal>
